...
<body class="container">
    ...
    <a class="btn btn-info" href="automobiliai.php">Automobiliai</a>
    <a class="btn btn-success" href="metai.php">Metai</a>
    <a class="btn btn-success" href="menuo.php">Menuo</a>
    <br><br>
</body>
</html>